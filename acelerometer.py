##########################
# Accelerometer file
# Autor: https://github.com/DcubeTechVentures/MMA8452Q/blob/master/Python/MMA8452Q.py
# Improved by: Arysson Oliveira
# This file should control the accelerometer peripheral
########################
